...
class Trainer(object):
    ...
    def step(self, mode):
        ...
        for index, (in_feature, out_feature_gt) in tqdm.tqdm(
            ...
            # find max value of confidence_weight
            max_echo  = np.max(object_idx)
            print('==========================')

            print('max_echo:', max_echo)
            print('current index:', index)
            # find 
            if max_echo > 2051799813685248:
                print('max_echo > 2051799813685248', max_echo)
                self.fail_count = self.fail_count + 1
                print('fail_count 1:', self.fail_count)
                continue
            ...
            if np.max(object_idx) > 2051799813685248:
                print('max_echo > 2051799813685248', np.max(object_idx))
                self.fail_count = self.fail_count + 1
                print('fail_count 4:', self.fail_count)
                continue
            ...
            print('max obj id :',np.max(object_idx))
            if np.max(object_idx) > 2051799813685248:
                print('max_echo > 2051799813685248', np.max(object_idx))
                self.fail_count = self.fail_count + 1
                print('fail_count 3:', self.fail_count)
                continue
            # check if object_idx is out of range
            # if class_weight[object_idx].shape[0] > 2051799813685248:

            #     print('max(object_idx) > 2051799813685248')
            #     self.fail_count = self.fail_count + 1
            #     print('fail_count 2:', self.fail_count)
            #     continue
            # else:
            #     print('shape is ',class_weight[object_idx].shape[0])
